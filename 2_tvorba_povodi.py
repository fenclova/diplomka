...
ctverec = r"C:\fenclova\diplomka\analyza\data\ctverce.gdb\fishnet_3"
...
rozvodnice_dissolve = arcpy.Dissolve(rozvodnice, "rozvodnice_dissolve.shp")
...
print [cislo, pocet_povodi, rozvodnice_delka, reky_delka]