...
##########################################################################################################
print "Start 0_predvyber_vodni_tok2.py:"
...
if not arcpy.Exists("VodniTok_2.gdb"):
    outDatabase = str(arcpy.CreateFileGDB_management(out_folder_path= config.workspace, out_name="VodniTok_2", out_version="CURRENT"))
else:
    outDatabase = "VodniTok_2.gdb"
...
cislo = 1
while True:
    filename = config.workspace + "0_predvyber_vodni_tok2_%s.csv" % cislo
...
print "Konec 0_predvyber_vodni_tok2.py"
